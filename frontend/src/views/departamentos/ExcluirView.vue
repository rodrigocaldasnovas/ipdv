                  ...
                  <div class="card-head">
                    ...
                    <form @submit.prevent="exclua">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-control-wrap">
                            <input type="text" class="form-control" id="full-name" :value="getNomeCentroCusto(centro_de_custos_id)" disabled/>
                          </div>
                        </div>
                        <div class="form-group">
...
export default {
  ...
  methods: {
    ...mapActions('departamentos', ['actionListagem', 'actionExclua']),
    getNomeCentroCusto (id) {
      const sel = this.centrodecustoTodos.filter(item => {
        return (item.id === id)
      })
      return sel[0]?.nome
    },
